...
router.get("/", async function (req, res, next) {
  try {
    ...
    if (minEmployees) req.query.minEmployees = parseInt(minEmployees);
    if (maxEmployees) req.query.maxEmployees = parseInt(maxEmployees);
...
router.get("/:handle", async function (req, res, next) {
  try {
    ...
    company.jobs = await Job.getByComp(req.params.handle)
